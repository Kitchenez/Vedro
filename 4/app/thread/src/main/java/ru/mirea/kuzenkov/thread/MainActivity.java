package ru.mirea.kuzenkov.thread;
...
import ru.mirea.kuzenkov.thread.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainThread.setName("МОЙ НОМЕР ГРУППЫ: БСБО-09-21, НОМЕР ПО СПИСКУ: 11, МОЙ ЛЮБИМЫЙ ФИЛЬМ: X]");
